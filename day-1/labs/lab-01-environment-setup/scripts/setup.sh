...
main() {
    ...
    # section "Step 1/8: Installing Docker"
    ...
    # section "Step 2/8: Installing kubectl"
    ...
    # # Step 3: Install kind
    # section "Step 3/8: Installing kind"
    ...
    # # Step 4: Install Helm
    # section "Step 4/8: Installing Helm"
    ...
    # section "Step 5/8: Creating Kubernetes Cluster"
    ...
    section "Step 6/8: Deploying Monitoring Stack"
    ...
    # Step 7: Setup RBAC
    section "Step 7/8: Setting up RBAC Permissions"
    ...
    # Step 8: Install kmcp CLI (optional)
    section "Step 8/8: Installing kmcp CLI"
